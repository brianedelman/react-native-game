...
const SceneSplash = ({ isUserLoggedIn, navigation }) => {
    ...
    return (
        <TouchableWrapper handlePress={() => navigation.navigate(navigationTarget)}>
            <DefaultPage>
                <Image style={{ width: 150, height: 120 }} source={AbeLogo} />
                <View>
                    <Text style={{ fontSize: 23, marginTop: 80 }}>by Konrad Abe</Text>
                </View>
            </DefaultPage>
        </TouchableWrapper>
    );
...
export default connect(mapStateToProps)(SceneSplash);
